...
const LiveChat = () => {
  const chatDB = [
    {
      replyElem: null,
      chatAvatar: "./assets/logo/Details.png",
    ...
    {
      replyElem: null,
      chatAvatar: "./assets/logo/unsplash_O3ymvT7Wf9U.png",
      chatName: "Monica22",
    ...
    {
      replyElem: null,
      chatAvatar: "./assets/logo/unsplash_7kQ3cdG2rJI.png",
      chatName: "Sarah012",
    ...
    {
      replyElem: {
        senderAvatar: "./assets/logo/unsplash_O3ymvT7Wf9U.png",
  ...
  return (
    <div className="absolute lg:-top-[81px] lg:left-[198px] md:-top-[81px] md:left-[98px] hidden md:block">
      ...
      >
        <div className="mt-[7px] mr-[8px] luci-red-btn py-[15px] px-[16px]">
